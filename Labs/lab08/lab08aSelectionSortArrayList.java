...
public class lab08aSelectionSortArrayList {
	
	/**
	 * Modifies the given ArrayList by sorting the array using selectionSort1
	...
	public static void main(String[] args) {
		...
		System.out.println("TESTING selectionSort2");
		System.out.println("======================");
		
		arrL1 = new ArrayList<>(Arrays.asList(5, 9, 3, 8, 2, 0, 7, 4, 6, 1));

		System.out.println("Original: "+arrL1);
		selectionSort2(arrL1);
		System.out.println("Sorted:   "+arrL1 + "; " + 
				(arrL1.equals(expectedSortedArrL1) ? "PASSED!" : "FAILED!"));
		System.out.println("---------");
